...
const Login: React.FunctionComponent<LoginProps> = () => {
    return (
        <div>
            <section className="w-full px-8 py-16 bg-gray-100 xl:px-8 h-screen">
                <div className="max-w-5xl mx-auto">
                    <div className="flex flex-row justify-center items-center">
                        <div className="w-full mt-16 md:mt-32 md:w-2/5">
            ...
            <section className="text-gray-700 bg-white body-font absolute bottom-0 left-0 w-full">
                <div className="container flex flex-col items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
                    <a href="#_" className="text-xl font-black leading-none text-gray-900 select-none logo">Unknow<span className="text-indigo-600">.</span></a>
                    <p className="mt-4 text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l sm:border-gray-200 sm:mt-0">© 2021 Unknow - Tailwindcss Page Builder
                    </p>
