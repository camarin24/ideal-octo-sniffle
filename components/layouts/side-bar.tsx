...
const SideBar: React.FC<SideBarProps> = () => {
    ...
    const toggleOpen = (ev) => {
        sideBar.current.classList.toggle("dark");
    }

    return <div ref={ sideBar } className="flex flex-col w-14 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
